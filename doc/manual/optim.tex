...
\item[O4] Activates the highest level of optimization using Local Stochastic Search. It is usually much faster than MCTS and may give better results.
\end{description}
...
\end{description}
The cooling rate from saMaxT to saMinT is exponential in saIter. More can be read in the following paper: \url{https://arxiv.org/pdf/1409.5223.pdf}.
