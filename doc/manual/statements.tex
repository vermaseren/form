...
(\ref{substafrompolynomial}) and the section on extra symbols 
...
(\ref{substatopolynomial}) and ExtraSymbols (\ref{stubstaextrasymbols},
\ref{sect-extrasymbols}).
\end{tabular} \vspace{4mm}
...
\leftvitem{3cm}{oldfactarg\index{off!oldfactarg}}
...
\leftvitem{3cm}{totalsize\index{off!totalsize}}
...
\leftvitem{3cm}{oldfactarg\index{on!oldfactarg}}
...
\leftvitem{3cm}{totalsize\index{on!totalsize}}
...
(\ref{substafrompolynomial}) and ExtraSymbols (\ref{stubstaextrasymbols},
\ref{sect-extrasymbols}).
\end{tabular} \vspace{4mm}
...
\leftvitem{3cm}{tosumnotation\index{transform!tosumnotation}\index{tosumnotation}
...
\leftvitem{3cm}{tointegralnotation\index{transform!tointegralnotation}
...
\leftvitem{3cm}{islyndon\index{transform!islyndon}\index{islyndon}}
...
\leftvitem{3cm}{tolyndon\index{transform!tolyndon}\index{tolyndon}}
