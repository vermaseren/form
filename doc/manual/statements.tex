...
symmetrize statements (see \ref{substasymmetrize}). \vspace{4mm}
...
\noindent The presense of a $+$ or $-$ after the bracket (or anti bracket) 
...
properties of the preceeding function. These can be (name indicates the 
...
more details, see the chapter on gamma\index{gamma algebra} algebra 
\ref{gammaalgebra}. \vspace{10mm}
...
antibracket\index{antibracket} statement in the preceeding module) are 
...
is exceed {\FORM} will split the bracket contents over more than one term, 
...
\noindent The action of this stament is to cycle-symmetrize the (specified) 
...
\rightvitem{12cm}{Declares the number to be the default dimension.}
...
dimension. The second symbol will be the the first symbol minus 4. It will 
...
n-dimensional. The expression must previously have been bracketted in these 
...
\leftvitem{3cm}{float\index{float}\index{format!float} \hfill \\ \ \ \ \ {\tt[}$<$number$>${\tt]}}
...
\leftvitem{3cm}{rational\index{rational}\index{format!rational}}
...
\leftvitem{3cm}{nospaces\index{nospaces}\index{format!nospaces}}
...
\leftvitem{3cm}{spaces\index{spaces}\index{format!spaces}}
...
\leftvitem{3cm}{fortran\index{fortran}\index{format!fortran}}
...
\leftvitem{3cm}{doublefortran\index{doublefortran}\index{format!doublefortran}}
...
\leftvitem{3cm}{fortran90\index{fortran90}\index{format!fortran90}}
...
\leftvitem{3cm}{C\index{C}\index{format!C}}
\rightvitem{13cm}{Output will be C compatible. The
exponent\index{exponent operator} operator ($\wedge$) is represeted by the 
...
\leftvitem{3cm}{reduce\index{reduce}\index{format!reduce}}
\rightvitem{13cm}{Output will be as much as possible compatible with 
...
order of declaration of variables.}\vspace{2mm}
...
\leftvitem{3cm}{count()\index{count}}
...
\leftvitem{3cm}{match()\index{match}}
...
\leftvitem{3cm}{expression()\index{expression}}
...
\leftvitem{3cm}{findloop()\index{findloop}}
...
\leftvitem{3cm}{multipleof()\index{multipleof}}
...
FORM to interprete the hierarchy\index{hierarchy} of the operators 
...
expressions, this stamement can cause each expression to be executed by its 
...
inbetween will then be executed on the contents of the \$-variables that 
...
the label can be any name or number. Control can be transfered to the 
...
integer. The overal factor that is needed to make the coefficients like 
described is taken from the overal factor of the complete term. Example
\begin{verbatim}
    S   a,b,c;
    CF  f;
...
\\ See also & polyfun (\ref{substapolyfun}),
              slavepatchsize (\ref{substaslavepatchsize}),
...
\leftvitem{3cm}{parallel\index{moduleoption!parallel}}
...
\leftvitem{3cm}{noparallel\index{moduleoption!noparallel}}
\rightvitem{13cm}{Vetoes parallel\index{parallel} execution of the current module.}

\leftvitem{3cm}{inparallel\index{moduleoption!inparallel}}
...
\leftvitem{3cm}{notinparallel\index{moduleoption!notinparallel}}
\rightvitem{13cm}{This option is more or less equivalent to the 
...
\leftvitem{3cm}{polyfun\index{moduleoption!polyfun}}
...
\leftvitem{3cm}{slavepatchsize\index{moduleoption!slavepatchsize}}
\rightvitem{13cm}{Followed by a number. Similar to the 
slavepatchsize\index{slavepatchsize} 
statement (see \ref{substaslavepatchsize}) but only valid for the current 
module.}

\leftvitem{3cm}{local\index{moduleoption!local}}
...
\leftvitem{3cm}{maximum\index{moduleoption!maximum}}
...
\leftvitem{3cm}{minimum\index{moduleoption!minimum}}
\rightvitem{13cm}{Should be followed by a list of 
\$-variables\index{\$-variable}. Indicates that of the contents of the 
...
\leftvitem{3cm}{sum\index{moduleoption!sum}}
\rightvitem{13cm}{Should be followed by a list of 
...
basis, the normal action of \FORM\ will be to veto parallel execution 
unless it is clear that no confusion can occur. See also the chapters on 
the parallel version(\ref{parallel}) and on the dollar 
variables(\ref{pardollars}).\vspace{10mm}
...
(installation dependend but at least 10000) maximum power for symbols and 
...
\noindent When the value for the modulus arithmetic is a prime\index{prime} 
...
%--#[ modulusgcd : To do <------
%
%	ModulusGCD,m,x,f1,f2;   Look inside factor.c
%	Assume m fits inside a word and x is a symbol.
%	Takes all occurrences of function f1 in the variable x.
%	Takes the arguments mod m and determines their GCD.
%	Puts the result in f2. Leaves the f1.
%	Because it doesn't work too well yet is isn't officially supported.
%
%--#] modulusgcd : 
%--#[ multi :
...
\leftvitem{3cm}{stats\index{nwrite!stats}}
\rightvitem{13cm}{Same as: Off stats;}

\leftvitem{3cm}{statistics\index{nwrite!statistics}}
\rightvitem{13cm}{Same as: Off statistics;}

\leftvitem{3cm}{shortstats\index{nwrite!shortstats}}
\rightvitem{13cm}{Same as: Off shortstats;}

\leftvitem{3cm}{shortstatistics\index{nwrite!shortstatistics}}
\rightvitem{13cm}{Same as: Off shortstatistics;}

\leftvitem{3cm}{warnings\index{nwrite!warnings}}
\rightvitem{13cm}{Same as: Off warnings;}

\leftvitem{3cm}{allwarnings\index{nwrite!allwarnings}}
\rightvitem{13cm}{Same as: Off allwarnings;}

\leftvitem{3cm}{setup\index{nwrite!setup}}
\rightvitem{13cm}{Same as: Off setup;}

\leftvitem{3cm}{names\index{nwrite!names}}
\rightvitem{13cm}{Same as: Off names;}

\leftvitem{3cm}{allnames\index{nwrite!allnames}}
\rightvitem{13cm}{Same as: Off allnames;}

\leftvitem{3cm}{shortstats\index{nwrite!shortstats}}
\rightvitem{13cm}{Same as: Off shortstats;}

\leftvitem{3cm}{highfirst\index{nwrite!highfirst}}
\rightvitem{13cm}{Same as: Off highfirst;}

\leftvitem{3cm}{lowfirst\index{nwrite!lowfirst}}
\rightvitem{13cm}{Same as: Off lowfirst;}

\leftvitem{3cm}{powerfirst\index{nwrite!powerfirst}}
...
\leftvitem{3cm}{allnames\index{off!allnames}}
\rightvitem{13cm}{Turns the allnames mode off. The default.}
 
\leftvitem{3cm}{allwarnings\index{off!allwarnings}}
\rightvitem{13cm}{Turns off the printing of all warnings.}

\leftvitem{3cm}{checkpoint\index{off!checkpoint}}
\rightvitem{13cm}{Deactivates the checkpoint mechanism. See
\ref{checkpoints}.}

\leftvitem{3cm}{compress\index{off!compress}}
\rightvitem{13cm}{Turns compression mode off.}
 
\leftvitem{3cm}{finalstats\index{off!finalstats}}
...
\leftvitem{3cm}{highfirst\index{off!highfirst}}
\rightvitem{13cm}{Puts the sorting in a low first mode.}

\leftvitem{3cm}{insidefirst\index{off!insidefirst}}
\rightvitem{13cm}{Not active at the moment.}
 
\leftvitem{3cm}{lowfirst\index{off!lowfirst}}
\rightvitem{13cm}{Leaves the default low first mode and puts the sorting in 
a high first mode.}
 
\leftvitem{3cm}{names\index{off!names}}
\rightvitem{13cm}{Turns the names mode off. This is the default.}

\leftvitem{3cm}{nospacesinnumbers\index{off!nospacesinnumbers}}
\rightvitem{13cm}{\label{staoffnospacesinnumbers}Makes that very long numbers are printed with leading 
blank spaces at the beginning of a new line. The numbers are usually broken 
up by placing a backspace character at the end of the line and then 
continuing at the next line. For cosmetic purposes FORM puts usually a few 
blank spaces at the beginning of the line. FORM itself can read this but 
some programs cannot. This option can be turned off by the `on 
nospacesinnumbers;' statement. The printing of the blank characters can be 
restored by turning this variable off. See also page 
\ref{nospacesinnumbers} for a corresponding variable in the setup file.}
 
\leftvitem{3cm}{parallel\index{off!parallel}}
\rightvitem{13cm}{Disallows the running of the program in parallel mode 
(only relevant for parallel versions of FORM).}
 
\leftvitem{3cm}{powerfirst\index{off!powerfirst}}
\rightvitem{13cm}{Puts the sorting back into `highfirst' mode.}

\leftvitem{3cm}{propercount\index{off!propercount}}
...
\leftvitem{3cm}{properorder\index{off!properorder}}
\rightvitem{13cm}{Turns the properorder mode off. This is the default.}
 
\leftvitem{3cm}{setup\index{off!setup}}
\rightvitem{13cm}{Switches off the mode in which the setup parameters are 
printed. This is the default.}

\leftvitem{3cm}{stats\index{off!stats}}
\rightvitem{13cm}{Same as `Off statistics'.}

\leftvitem{3cm}{statistics\index{off!statistics}}
\rightvitem{13cm}{Turns off the printing of statistics.}

\leftvitem{3cm}{shortstats\index{off!shortstats}}
\rightvitem{13cm}{Same as `Off shortstatistics'.}

\leftvitem{3cm}{shortstatistics\index{off!shortstatistics}}
...
\leftvitem{3cm}{threadloadbalancing\index{off!threadloadbalancing}}
\rightvitem{13cm}{Disallows the loadbalancing of \TFORM in parallel mode. 
In other versions of FORM this option is ignored.}
 
\leftvitem{3cm}{threads\index{off!threads}}
\rightvitem{13cm}{Disallows multithreaded running in \TFORM.
In other versions of FORM this option is ignored.}

\leftvitem{3cm}{threadstats\index{off!threadstats}}
\rightvitem{13cm}{Turns off the thread by thread printing of the statitics 
in \TFORM. Only the master thread will be printing statistics. Other 
versions of FORM will ignore this option.}

\leftvitem{3cm}{warnings\index{off!warnings}}
...
\leftvitem{3cm}{checkpoint\index{on!checkpoint}}
...
\leftvitem{3cm}{compress\index{on!compress}}
...
saves roughly a factor two in diskstorage. The old statement was `compress 
on' but this should be avoided in the future. This setting is the default.}

\leftvitem{3cm}{compress,gzip\index{gzip}}
...
\leftvitem{3cm}{fewerstatistics\index{on!fewerstatistics}}
...
\leftvitem{3cm}{nospacesinnumbers\index{on!nospacesinnumbers}}
\rightvitem{13cm}{\label{staonnospacesinnumbers}Makes that very long numbers are printed with no leading 
blank spaces at the beginning of a new line. The numbers are usually broken 
up by placing a backspace character at the end of the line and then 
continuing at the next line. For cosmetic purposes FORM puts usually a few 
blank spaces at the beginning of the line. FORM itself can read this but 
some programs cannot. Hence this printing of the blank characters can be 
omitted by turning this variable on. See also page 
\ref{nospacesinnumbers} for a corresponding variable in the setup file.}
 
\leftvitem{3cm}{parallel\index{on!parallel}}
...
\leftvitem{3cm}{properorder\index{on!properorder}}
...
\leftvitem{3cm}{shortstats\index{on!shortstats}}
\rightvitem{13cm}{Same as `On shortstatistics'.}

\leftvitem{3cm}{statistics\index{on!statistics}}
...
\leftvitem{3cm}{stats\index{on!stats}}
\rightvitem{13cm}{Same as `On statistics'.}
 
\leftvitem{3cm}{threadloadbalancing\index{on!threadloadbalancing}}
\rightvitem{13cm}{Causes the loadbalancing mechanism in TFORM to be turned 
on or off. Default is on. Ignored by other versions of FORM.}
 
\leftvitem{3cm}{threads\index{on!threads}}
...
\leftvitem{3cm}{threadstats\index{on!threadstats}}
...
\leftvitem{3cm}{warnings\index{on!warnings}}
...
\noindent General purpose print\index{print} statement. Has three modes. In 
...
execution. This allows the printing of indivudual terms or 
...
\ref{substasymmetrize}). \vspace{4mm}

\noindent The action of this stament is to
...
\noindent The staments inside the repeat environment should all be 
...
Currently the contents of the save file are still 
architecture\index{architecture dependent} dependent. 
...
in internal notation from one program to another. It is the prefered method 
...
and tables\index{table} counts as functions.
...
\noindent Sets the size\index{slavepatchsize} of the buffer for sending 
terms to the secondary processors in ParFORM\index{ParFORM}, one of the 
...
be readjusted to the value of maxtermsize\index{maxtermsize} (see 
...
\leftvitem{2cm}{x\hash{}r}
\rightvitem{14cm}{The symbol is real\index{real}. This is the default.}

\leftvitem{2cm}{x\hash{}c}
\rightvitem{14cm}{The symbol is complex\index{complex}. This means that two 
spaces are reserved for this symbol, one for x and one for x\hash (the 
complex conjugate).}

\leftvitem{2cm}{x\hash{}i}
\rightvitem{14cm}{The symbol is imaginary\index{imaginary}.}

\leftvitem{2cm}{x(:5)}
\rightvitem{14cm}{The symbol has the maximum power 5. This means that $x^6$ 
...
\leftvitem{2cm}{x(-3:)}
\rightvitem{14cm}{The symbol has the minimum power -3. This means that 
...
\leftvitem{2cm}{x(-3:5)}
\rightvitem{14cm}{The combination of a maximum and a minimum power 
...
\noindent The action of this stament is to symmetrize the 
...
declared with the ntable\index{ntable} statement (se \ref{substantable}). A 
...
\leftvitem{3cm}{allnames\index{write!allnames}}
\rightvitem{13cm}{Same as: On allnames;}

\leftvitem{3cm}{allwarnings\index{write!allwarnings}}
\rightvitem{13cm}{Same as: On allwarnings;}
 
\leftvitem{3cm}{highfirst\index{write!highfirst}}
\rightvitem{13cm}{Same as: On highfirst;}
 
\leftvitem{3cm}{lowfirst\index{write!lowfirst}}
\rightvitem{13cm}{Same as: On lowfirst;}

\leftvitem{3cm}{names\index{write!names}}
\rightvitem{13cm}{Same as: On names;}
 
\leftvitem{3cm}{powerfirst\index{write!powerfirst}}
\rightvitem{13cm}{Same as: On powerfirst;}
 
\leftvitem{3cm}{setup\index{write!setup}}
\rightvitem{13cm}{Same as: On setup;}
 
\leftvitem{3cm}{shortstatistics\index{write!shortstatistics}}
\rightvitem{13cm}{Same as: On shortstatistics;}

\leftvitem{3cm}{shortstats\index{write!shortstats}}
\rightvitem{13cm}{Same as: On shortstats;}
 
\leftvitem{3cm}{statistics\index{write!statistics}}
\rightvitem{13cm}{Same as: On statistics;}
 
\leftvitem{3cm}{stats\index{write!stats}}
\rightvitem{13cm}{Same as: On stats;}
 
\leftvitem{3cm}{warnings\index{write!warnings}}
