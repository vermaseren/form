...
\leftvitem{3cm}{float\index{float}\index{format!float} \hfill \\ \null\quad{\tt[}$<$number$>${\tt]}}
...
\rightvitem{13cm}{\label{staoffnospacesinnumbers}\vspace{1ex}Makes that very
long numbers are printed with leading blank spaces at the beginning of a new
...
\rightvitem{13cm}{\vspace{1.5ex}Disallows the loadbalancing of \TFORM\ in parallel mode. 
...
\leftvitem{2cm}{x\hash{}=number}
\rightvitem{14cm}{The symbol is a number-th root of
...
\leftvitem{3cm}{replace\index{transform!replace}\index{replace}}
...
\leftvitem{3cm}{encode\index{transform!encode}\index{encode}}
...
\leftvitem{3cm}{decode\index{transform!decode}\index{decode}}
...
\leftvitem{3cm}{implode\index{transform!implode}\index{implode}}
\rightvitem{13cm}{implode(r1,r2) realizes an encoding in which zeroes are 
absorbed as extra values in the first nonzero argument that is following. 
This is used when dealing with harmonic sums and harmonic polylogarithms. 
An example is that (0,0,1,0,a,0,0,0,-1) goes into (3,2*a,-4). Currently 
only a single symbol is allowed and the numbers should be (small) integers 
because otherwise the reverse operation (explode) would generate too many 
arguments.}

\leftvitem{3cm}{explode\index{transform!explode}\index{explode}}
\rightvitem{13cm}{explode(r1,r2) undoes what implode might have done. Hence 
each integer with an absolute value $n$ generates $n-1$ zeroes and leaves 
something with absolute value one.}

\leftvitem{3cm}{permute\index{transform!permute}\index{permute}}
\rightvitem{13cm}{permute(1,last)=(1,3,5)(2,6) will permute the arguments 
according to the cycles indicated. The cycles are executed in order and may 
overlap.}

\leftvitem{3cm}{reverse\index{transform!reverse}\index{reverse}}
\rightvitem{13cm}{reverse(r1,r2) reverses the order of the arguments in 
specified range.}

\leftvitem{3cm}{cycle\index{transform!cycle}\index{cycle}}
