...
VERSION\_     &\index{VERSION\_} The current version as the 4 in 4.0.\\
SUBVERSION\_  &\index{SUBVERSION\_} The sub-version as the 0 in 4.0.\\
...
the the \#enddo instruction of the number of loops indicated by `number'. 
