...
\noindent pi\_\index{pi\_}: a reserved variable which indicates the constant 
$\pi$.

\noindent ee\_\index{ee\_}: a reserved variable which indicates the basis of 
the natural logarithm $e$.

\noindent em\_\index{em\_}: a reserved variable which indicates the 
Euler-Mascheroni constant $\gamma_\mathrm{E}$.
