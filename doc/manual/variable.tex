...
variables. {\FORM} knows several types of variables\index{variables}, each 
...
for the names of dollar variables\index{variables!dollar} and the names of 
...
tables\index{tables}. The tables are described on page~\ref{substatable} 
