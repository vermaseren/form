...
DECLARE(VOID FiniLine,(VOID))
DECLARE(WORD FiniTerm,(WORD *,WORD *,WORD *,WORD,WORD))
DECLARE(VOID FlushCon,(VOID))
DECLARE(WORD FlushOut,(POSITION *,FILEHANDLE *))
DECLARE(VOID FunLevel,(WORD *))
DECLARE(VOID GarbHand,(VOID))
...
DECLARE(WORD GetParams,(VOID))
DECLARE(RENUMBER GetTable,(WORD,POSITION *))
DECLARE(WORD GetTerm,(WORD *))
DECLARE(WORD GetWithEcho,(VOID))
DECLARE(WORD Glue,(WORD *,WORD *,WORD *,WORD))
DECLARE(WORD InFunction,(WORD *,WORD *))
DECLARE(WORD IncLHS,(VOID))
DECLARE(WORD IncRHS,(WORD))
DECLARE(VOID IniGlob,(VOID))
DECLARE(VOID IniLine,(VOID))
DECLARE(WORD IniVars,(VOID))
DECLARE(VOID Init2,(VOID))
DECLARE(VOID Initialize,(VOID))
...
DECLARE(WORD PopVariables,(VOID))
DECLARE(WORD PrepPoly,(WORD *))
DECLARE(WORD Processor,(VOID))
DECLARE(WORD Product,(UWORD *,WORD *,WORD))
DECLARE(VOID PrtLong,(UWORD *,WORD,UBYTE *))
DECLARE(VOID PrtTerms,(VOID))
DECLARE(WORD PutBracket,(WORD *))
DECLARE(LONG PutIn,(FILEHANDLE *,POSITION *,WORD *,WORD **))
...
DECLARE(WORD SetFileIndex,(VOID))
DECLARE(WORD SetParams,(VOID))
DECLARE(WORD Sflush,(FILEHANDLE *))
DECLARE(WORD Simplify,(UWORD *,WORD *,UWORD *,WORD *))
DECLARE(WORD SkipWhite,(VOID))
...
DECLARE(VOID WriteLists,(VOID))
DECLARE(VOID WriteSetup,(VOID))
...
DECLARE(VOID inictable,(VOID))
DECLARE(int inicbufs,(VOID))
DECLARE(VOID StartFiles,(VOID))
DECLARE(UBYTE *MakeDate,(VOID))
DECLARE(VOID PreProcessor,(VOID))
...
DECLARE(int RecalcSetups,(VOID))
DECLARE(int AllocSetups,(VOID))
DECLARE(SORTING *AllocSort,(LONG,LONG,LONG,LONG,int,int,LONG))
DECLARE(UBYTE *LoadInputFile,(UBYTE *,int))
DECLARE(UBYTE GetInput,(VOID))
DECLARE(VOID ClearPushback,(VOID))
DECLARE(UBYTE GetChar,(int))
DECLARE(VOID CharOut,(UBYTE))
DECLARE(VOID UnsetAllowDelay,(VOID))
...
DECLARE(int PreProInstruction,(VOID))
...
DECLARE(VOID MakeGlobal,(VOID))
DECLARE(int ExecModule,(int))
DECLARE(int ExecStore,(VOID))
DECLARE(VOID FullCleanUp,(VOID))
DECLARE(int DoExecStatement,(VOID))
DECLARE(int DoPipeStatement,(VOID))
...
DECLARE(VOID DoubleIfBuffers,(VOID))
...
DECLARE(void CleanOptiBuffer,(VOID))
DECLARE(int PrintOptima,(WORD))
DECLARE(int FindScratchName,(VOID))
...
DECLARE(FILEHANDLE *AllocFileHandle,(VOID))
DECLARE(VOID DeAllocFileHandle,(FILEHANDLE *))
DECLARE(VOID LowerSortLevel,(VOID))
...
DECLARE(int MakeSetupAllocs,(VOID))
DECLARE(int TryFileSetups,(VOID))
...
DECLARE(void UpdatePositions,(VOID))
DECLARE(void M_check,(VOID))
DECLARE(void M_print,(VOID))
DECLARE(void M_check1,(VOID))
DECLARE(void PrintTime,(VOID))
...
DECLARE(void PolynoPopBracket,(VOID))
DECLARE(void PolynoStart,(VOID))
DECLARE(void PolynoFinish,(VOID))
